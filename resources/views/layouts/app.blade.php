    ...
    @if (env('APP_ENV') == 'production')
        ...
        <script>
            if(window.location.hostname== 'tour.simanof.com' || window.location.hostname== 'www.tour.simanof.com'){
                ...
                // Hotjar Tracking Code for https://tour.simanof.com

                (function(h,o,t,j,a,r){
                    h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
                    h._hjSettings={hjid:2306457,hjsv:6};
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md fixed-top navbar-light well  shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <div class="text-logo">Siman</div>
                    <div class="text-logo-2"> Orchestral </div>
                    <div class="text-logo"> Foundation</div>
        ...
        <footer>
            ...
            <p class="font-size-sm text-center mb-4 py-3"><span class=" opacity-50 mr-1">© 2021 <a
                        class="nav-link-style text-orange nav-link-light" href="http://simanof.com/" target="_blank"
                        rel="noopener">SIMAN ORCHESTRAL FOUNDATION.</a> All Rights Reserved. </span></p>
