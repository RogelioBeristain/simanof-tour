...
<div class="container">
    <div class="row ">
             ...
             <div class="col-md-12">
                <h3 class="text-regular-orange text-carbon">
                     <span class="text-header-title">
                      ...
                      It’s quick and easy.  <span class="text-orange">  <br> Tour Simanof</span>
        ...
        <div class="row pt-5">
      <div class="col-md-6">
              <img  class="picture-secundary rounded "src="{{asset('assets/nino_1.png') }}" alt="">
                             
        </div>
        <div class="col-md-6">
                 <img  class="picture-secundary rounded "src="{{asset('assets/nino_2.png') }}" alt="">
            ...
            <div class="card d-block  shadow  border-0 bg-white rounded  mx-auto mt-5">
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6" >
                                ...
                                <div class="form-group">
                                    <input id="first_name" type="text" placeholder="{{ __('First name') }}"
                                        class="form-control col-xs-12 col-sm-12 col-md-12  @error('first_name') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="last_name" type="text" placeholder="{{ __('Last name') }}"
                                        class="form-control col-xs-12 col-sm-12 col-md-12 @error('last_name') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="phone" type="tel" placeholder="{{ __('Phone') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="password-confirm" placeholder="{{ __('Password Confirm') }}" type="password"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <!--  <input id="name" type="text" placeholder="{{ __('First name') }}"
                                        class="form-control col-xs-12 col-sm-12 col-md-12  @error('name') is-invalid @enderror"
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <!--  <input id="last-name" type="text" placeholder="{{ __('Last name') }}"
                                        class="form-control col-xs-12 col-sm-12 col-md-12 @error('last-name') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="radio" required name="gender" value="female" class="form-check-input" id="radio-fe">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group form-check">
                                    <input type="radio" required name="gender"  value="male" class="form-check-input" id="radio-ma">
                        ...
                        <div class="row">
                             <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="radio" required  name="type_account"  value="aspirant" class="form-check-input" id="exampleCheck1">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group form-check">
                                    <input type="radio" required   name="type_account"  value="tutor" class="form-check-input" id="exampleCheck1">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 ">
                                <button type="submit" class="btn btn-primary btn-xl-purple">
                                    {{ __("Sign Up") }}
                                </button>
                                  <a  class="text-orange" href="{{ route('login') }}"> Login</a>
                            </div>
                        </div>
                    </form>
                </div>
